<template>
  <el-card style="width: 500px;margin-top: 5vh;margin-left: 23vw">
    <el-form label-width="80px" size="small">
      ...
      <el-form-item label="邮箱">
        <el-button style="width: 100% ;height: 30px;text-align: left;font-size: small"
                   @click="handleEmail">
          <span  v-if="form.email">{{form.email}}</span>
          <span  v-else>点击认证</span>
        </el-button>
      </el-form-item>
      <el-form-item label="律师认证">
        <el-button style="width: 100% ;height: 30px;text-align: left;font-size: small"
                   @click="viewOfficeDialogVis=true">
          <span  v-if="form.office">{{form.office}}</span>
          <span  v-else>点击认证</span>
        </el-button>
      </el-form-item>
