<template>
  <div style="width: 100%;min-height: calc(100vh - 60px);margin-top: -20px;background-color: #f5f9f6">
    <div style="width: 70%;margin-left: 15%;">
      ...
      <div style="color: #666">
        ...
        <div style="margin: 20px 0;font-size: 16px;">
          <h1 style="margin-bottom: 20px; color: #333333" align="center" >{{article.title}}</h1>
          <mavon-editor
              class="md"
              ...
              :ishljs="true"
          />
          <a v-if="article.type === '1'" :href="article.address" target="_blank" >
            <el-button size="medium" type="warning" style="float: right;margin: 5px;">Paper</el-button>
          </a>
        </div>
        <!--输入评论-->
            ...
            <div v-for="item in comments" :key="item.id" style="border-bottom: 1px solid #ccc; padding: 10px 0; ">
              <div style="display: flex">
                <div style="width: 100px; text-align: center">
                  <el-image :src="item.avatarUrl?item.avatarUrl:circleUrl" style="width: 50px; height: 50px; border-radius: 50%" ></el-image>
                </div> <!--  头像-->
