<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入事务所" suffix-icon="el-icon-position" class="ml-5" v-model="office"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="role" label="角色" width="110px">
        <template slot-scope="scope">
          ...
          <el-tag type="success" v-if="scope.row.role === 'ROLE_LAWYER'">医生</el-tag>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="事务所">
          <el-select clearable v-model="form.office" placeholder="请选择事务所" style="width: 100%">
